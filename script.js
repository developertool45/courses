    ...
    var container = document.querySelector('#test-parent'); 
    let allTests;
   async function getTests() {
     let rdata = await fetch(`https://api.classplusapp.com/v2/course/preview/diy/similar/eyJ0dXRvcklkIjpudWxsLCJvcmdJZCI6Njc5NDE0LCJjYXRlZ29yeUlkIjpudWxsfQ`)
        const data = await rdata.json();
        // console.log(data.data.all.coursesData);    
   ...
   async function getCourse() {
     let crs = await fetch(
       ...
       console.log(data.data.coursesData);
        ...
        element = tests[i];        
         container.innerHTML += `
            ...
            `<div class="content1">
                ...
                <div class="actionbtn">
                    <button class="Buy-btn" onClick="window.location.href='${element.singlePaymentLink}'">Free Demo</button>
                </div>
